...
class ListfollowedPage extends StatefulWidget {
  const ListfollowedPage({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<ListfollowedPage> createState() => _ListfollowedPageState();
}

class _ListfollowedPageState extends State<ListfollowedPage> {
