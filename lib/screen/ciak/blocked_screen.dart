...
import 'package:ciak_live/controller/list_blocked.dart';
import 'package:ciak_live/screen/ciak/profile_other_screen.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';

class ListblockedPage extends StatefulWidget {
  const ListblockedPage({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<ListblockedPage> createState() => _ListblockedPageState();
}

class _ListblockedPageState extends State<ListblockedPage> {
  ...
  Future<void> _getData() async {
    ...
    getBlocked(id!, ucode!, rcode!, header!, profile!, nickname!, timezone!)
        .then((value) async {
