...
import 'package:ciak_live/controller/list_following.dart';
...
class ListfollowingPage extends StatefulWidget {
  const ListfollowingPage({Key? key, required this.title}) : super(key: key);
  final String title;
...
class _ListfollowingPageState extends State<ListfollowingPage> {
  ...
  Future<void> _getData() async {
    ...
    getFollowing(id!, ucode!, rcode!, header!, profile!, nickname!, timezone!)
        .then((value) async {
